...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: FaFacebookF, href: 'https://facebook.com/artnetwork', label: 'Facebook' },
    { icon: FaInstagram, href: 'https://instagram.com/artnetwork', label: 'Instagram' },
    { icon: FaLinkedinIn, href: 'https://linkedin.com/company/artnetwork', label: 'LinkedIn' },
    { icon: FaWhatsapp, href: 'https://wa.me/351965093138', label: 'WhatsApp' },
  ];
      ...
      <div className="container-custom px-6 lg:px-12">
        <div className="flex flex-col md:flex-row justify-between items-start gap-12 lg:gap-24 mb-24">
          ...
          <div className="md:text-right">
             <h4 className="text-[10px] uppercase font-body font-bold tracking-[0.3em] text-white/20 mb-8">Portugal</h4>
             <p className="text-white font-heading text-lg mb-2 italic">Global Presence</p>
             <a href="mailto:artnetworkconsult@gmail.com" className="text-white/40 hover:text-white transition-colors text-sm font-body">artnetworkconsult@gmail.com</a>
          </div>
        </div>
