...
// Lazy load Spline only on desktop — keeps ~5MB out of mobile bundle
    ...
    >
          ...
          <Suspense fallback={<HeroFallback />}>
            ...
            {!isLoaded && (
              <div className="absolute inset-0 flex items-center justify-center bg-black">
                <div className="text-white/60 tracking-widest text-xs font-body font-bold animate-pulse">
      ...
      <div className="container-custom relative z-10 px-6 lg:px-12 w-full pt-16 lg:pt-0 pointer-events-none">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8 mt-12 mb-8">
          ...
          <div
            className="w-full lg:w-[60%] flex flex-col items-start text-left lg:py-12 pointer-events-auto"
            style={{ animation: 'heroFadeUp 0.9s cubic-bezier(0.16, 1, 0.3, 1) both' }}
          >
            <div className="flex items-center gap-4 mb-6">
              <span className="h-px w-12 bg-artnetwork-primary" />
              <span className="text-white/90 text-sm font-body font-bold uppercase tracking-[0.25em] flex items-center gap-3">
                ...
                <span className="px-2 py-0.5 rounded-full bg-artnetwork-primary/20 text-artnetwork-primary border border-artnetwork-primary/30 text-[9px] flex items-center gap-1">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-6 mt-2 pointer-events-auto">
              <button
                onClick={() => scrollToSection('contacto', scrollOffset)}
                className="px-8 py-4 bg-artnetwork-primary hover:bg-white text-white hover:text-black font-body font-bold text-sm uppercase tracking-widest rounded-none transition-all duration-300 flex items-center justify-center gap-3 group cursor-pointer border-none"
              >
              ...
              <button
                onClick={() => scrollToSection('portfolio', scrollOffset)}
            ...
            {/* Stats Bar */}
            <div className="mt-12 pt-6 sm:pt-8 sm:border-t border-white/20 flex flex-col sm:flex-row items-start sm:items-center gap-6 sm:gap-12 max-w-lg pointer-events-auto bg-black/80 md:bg-white/5 md:backdrop-blur-md p-6 border border-white/10 relative overflow-hidden">
              <div className="absolute inset-0 bg-artnetwork-primary/5 hidden sm:block" />
      ...
      >
        ...
        <div className="w-16 h-[1px] bg-white/20 relative overflow-hidden">
          <div 
            className="absolute top-0 left-0 w-full h-full bg-artnetwork-primary"
      ...
      <style>{`
        ...
        @keyframes scrollLine {
          ...
          49%  { transform: scaleX(1); transform-origin: 0% 50%; }
